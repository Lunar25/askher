...
public class VoiceAPI {
    ...
    public static void getVoiceEng(String text) {
        String myAPIUrl = "https://api.au-syd.text-to-speech.watson.cloud.ibm.com/instances/b08160fe-3755-4a84-b20f-0e294ed921b6";
        IamAuthenticator authenticator = new IamAuthenticator("R9ddxroA5plfiim07vTY61O-TxllEiBKoeEJsmpzpi6L");
    ...
    public static void getVoiceVie(String text) throws Exception {
        VoiceProvider tts = new VoiceProvider("2a1ca8d86de94069a4fc7e488f952ad3");
